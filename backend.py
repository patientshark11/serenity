...
def generative_search(query, weaviate_client, openai_client, model="gpt-4"):
    ...
    hyde_prompt = f"Write a detailed, factual paragraph that directly answers the following question. Do not say 'this is a hypothetical answer' or similar. Just provide the answer as if it were accurate: {query}"
    try:
